...
The datasets have a large number of values that take too much to process. Hence we sample `1%` of the data, i.e which is `r 8992 + 772 + 23601` lines of data which should turn a reasonable accuracy for the model.
```{r sampling the data}
    set.seed(2020)
